...
if __name__=='__main__':
	...
	for topic in topics:
		...
		while runs<=total:
			...
			if sys.argv[2]=='my':
				import my_system
				my_system.run(inFile, outFile, pickleFile, topic, factorWeights, aggregateTopics)
			else:
				run_agdistis.run(inFile, outFile, pickleFile, topic, aggregateTopics)
			runs+=1
